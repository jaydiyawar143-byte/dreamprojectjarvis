  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-sys-void px-6">
      <div className="text-center">
        <p className="font-mono text-xs uppercase tracking-hud text-sys-dim">Error 404</p>
        ...
        <Link
          href="/dashboard"
          className="sys-focus mt-6 inline-block rounded border border-sys-cyan/40 bg-sys-cyan/10 px-4 py-2 font-mono text-xs uppercase tracking-hud text-sys-cyan"
        >
          Back to dashboard
        </Link>
      </div>
